...
const Newsletter = () => {
    return (
        <div className="bg-black">
            <div className="max-w-7xl 2xl:max-w-[1800px] mx-auto grid sm:grid-cols-2 grid-cols-1 gap-8 py-12 px-4 sm:px-6 lg:py-16 lg:px-8 justify-center items-center">
                <div>

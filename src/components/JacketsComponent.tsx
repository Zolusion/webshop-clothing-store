...
const products = [
    {
        ...
        price: 79.99,
        imageUrl: 'https://i.pinimg.com/474x/a2/95/2b/a2952bd4ddeafe9102caa3ba6ae9e30d.jpg',
    ...
    {
        id: 2,
        productName: 'Quilted Winter Coat',
        ...
        brand: 'WarmStyle',
        price: 89.95,
        imageUrl: 'https://i.pinimg.com/474x/08/0e/f4/080ef406bcf1ff0ed8216e704b9d25c9.jpg',
    ...
    },
    {
        ...
        brand: 'DenimStyle',
        price: 49.99,
        imageUrl: 'https://i.pinimg.com/474x/bd/e8/c7/bde8c782b8645029f66e80b3850983b1.jpg',
        category: 'Denim',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        brand: 'WinterChic',
        price: 69.99,
        imageUrl: 'https://i.pinimg.com/474x/9f/08/09/9f0809bc17aebe0c65d19e789fb3d914.jpg',
    ...
    {
        id: 5,
        productName: 'Faux Leather Biker Jacket',
        ...
        brand: 'RebelStyle',
        price: 59.95,
        imageUrl: 'https://i.pinimg.com/474x/a8/ac/63/a8ac63cb5d3fb74f7337658170b18434.jpg',
        category: 'Leather Coats',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        price: 79.99,
        imageUrl: 'https://i.pinimg.com/474x/52/aa/ac/52aaac03a646b61ce0705924e7541a27.jpg',
        category: 'Winter Jackets',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    {
        id: 7,
        productName: 'Quilted Leather Bomber',
        ...
        brand: 'UrbanElegance',
        price: 99.99,
        imageUrl: 'https://i.pinimg.com/474x/65/ca/c6/65cac655f75d388b6a94669b51cb7bca.jpg',
        category: 'Leather Coats',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    {
        id: 8,
        productName: 'Sheepskin Shearling Coat',
        ...
        brand: 'CasualComfort',
        price: 39.99,
        imageUrl: 'https://i.pinimg.com/474x/65/23/cf/6523cf63fdd848766b4e953128518091.jpg',
        category: 'Leather Coats',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    {
        id: 9,
        productName: 'Temparament Tweed Suit',
        ...
        brand: 'OutdoorReady',
        price: 129.95,
        imageUrl: 'https://i.pinimg.com/564x/c1/50/d4/c150d424d714fc099a6d1add0f8bd025.jpg',
        category: 'Blazers',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    {
        id: 10,
        productName: 'Fur-Lined Winter Parka',
        ...
        brand: 'WinterLuxury',
        price: 109.99,
        imageUrl: 'https://i.pinimg.com/474x/44/59/79/445979a15cd204004e1138d892ee8b91.jpg',
        category: 'Winter Jackets',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        brand: 'StreetStyle',
        price: 79.99,
        imageUrl: 'https://i.pinimg.com/474x/96/c2/28/96c228439d75de113e4e6f0c9e7398ab.jpg',
    ...
    {
        id: 12,
        productName: 'Classic Office Jacket',
        ...
        brand: 'CasualComfort',
        price: 59.95,
        imageUrl: 'https://i.pinimg.com/474x/8f/8e/16/8f8e165151dded0fd7b9e7587dd9878a.jpg',
    ...
    },
    {
        ...
        brand: 'CasualComfort',
        price: 59.95,
        imageUrl: 'https://i.pinimg.com/474x/49/e1/90/49e190abd03c03c9b8891dd0fae3e75d.jpg',
    ...
    },
    {
        ...
        brand: 'CasualComfort',
        price: 38.95,
        imageUrl: 'https://i.pinimg.com/564x/2e/cd/30/2ecd309714ce45688c2e3d4b602dc685.jpg',
        category: 'Blazers',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        brand: 'CasualComfort',
        price: 29.95,
        imageUrl: 'https://i.pinimg.com/564x/a0/9e/6c/a09e6c9ebc28349299ec4796b91362c4.jpg',
        category: 'Blazers',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        brand: 'CasualComfort',
        price: 39.95,
        imageUrl: 'https://i.pinimg.com/564x/ae/50/8c/ae508c026b8b7e401695e4e49c551a51.jpg',
        category: 'Puffer Jacket',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        brand: 'CasualComfort',
        price: 34.95,
        imageUrl: 'https://i.pinimg.com/564x/85/7d/7d/857d7d0b3f5234d99eda6de11daf4d31.jpg',
        category: 'Puffer Jacket',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        brand: 'CasualComfort',
        price: 59.95,
        imageUrl: 'https://i.pinimg.com/564x/73/99/82/739982e3a04cdd85141a9d6b0fa0590e.jpg',
        category: 'Blazers',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    {
        id: 19,
        productName: 'Flap Pocket Crop Denim Jacket',
        ...
        brand: 'CasualComfort',
        price: 39.95,
        imageUrl: 'https://i.pinimg.com/564x/a7/b4/7f/a7b47fa8ed60186ade85ab5e21efa5cd.jpg',
        category: 'Denim',
        button: {
            cart: "Add to Cart",
            link: "#",
    ...
    },
    {
        ...
        brand: 'CasualComfort',
        price: 29.95,
        imageUrl: 'https://i.pinimg.com/564x/f3/c6/3d/f3c63d4135ee3e4f48ef4e99ab052e22.jpg',
        category: 'Denim',
        button: {
            cart: "Add to Cart",
            link: "#",

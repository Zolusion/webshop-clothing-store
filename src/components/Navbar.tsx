            ...
            <div className="flex justify-between items-center container mx-auto p-4 max-w-7xl 2xl:max-w-[2200px]">
                ...
                <div className="hidden md:flex flex-grow items-center justify-center space-x-8 font-medium">
                    <ul className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8">
                        ...
                        <li><Link href="/about" className="2xl:text-[21px] block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">About</Link></li>
                        <li><Link href="/contact" className="2xl:text-[21px] block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Contact</Link></li>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart3 2xl:w-6 2xl:h-6" viewBox="0 0 16 16">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-suit-heart-fill 2xl:w-6 2xl:h-6" viewBox="0 0 16 16">

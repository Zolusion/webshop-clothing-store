...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-gray-900">
            <div className="flex justify-between items-center container mx-auto p-4 max-w-7xl 2xl:max-w-[1800px]">
                <a href="https://flowbite.com" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <Image
                        ...
                        loading="lazy"
                    />
                    <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">SolmazFashion</span>
                </a>
                ...
                <div className="hidden md:flex flex-grow items-center justify-center space-x-8 font-medium">
                    <ul className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8">
                        <li><Link href="/" className="2xl:text-lg block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Home</Link></li>
                        <li><Link href="/about" className="2xl:text-lg block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">About</Link></li>
                        <li><Link href="/contact" className="2xl:text-lg block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Contact</Link></li>
                        <li><Link href="/ambassadors" className="2xl:text-lg block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Ambassadors</Link></li>
                    </ul>
                </div>
